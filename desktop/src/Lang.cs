...
public static class Lang
{
    ...
    public static class K
    {
        ...
        // Chain editor (editable STT/polish order + custom provider)
        public const string ChainSttTitle = "chain_stt_title";
        public const string ChainPolishTitle = "chain_polish_title";
        public const string ChainReset = "chain_reset";
        public const string ChainResetTip = "chain_reset_tip";
        public const string ChainSttHint = "chain_stt_hint";
        public const string ChainPolishHint = "chain_polish_hint";
        public const string ChainCustomTitle = "chain_custom_title";
        public const string ChainCustomId = "chain_custom_id";
        public const string ChainCustomName = "chain_custom_name";
        public const string ChainCustomBase = "chain_custom_base";
        public const string ChainCustomKey = "chain_custom_key";
        public const string ChainCustomModel = "chain_custom_model";
        public const string ChainCustomAdd = "chain_custom_add";
        public const string ChainCustomAddTip = "chain_custom_add_tip";
        public const string ChainCustomHint = "chain_custom_hint";
        public const string ChainNoteCustomStt = "chain_note_custom_stt";
        public const string ChainNoteUnknown = "chain_note_unknown";
        public const string ChainPolishDefault = "chain_polish_default";
        public const string ChainPolishGoogleFallback = "chain_polish_google_fallback";
        public const string ChainPolishGroq = "chain_polish_groq";
        public const string ChainPolishCustomMissing = "chain_polish_custom_missing";
        public const string ChainSaved = "chain_saved";
        public const string ChainSttSaved = "chain_stt_saved";
        public const string ChainPolishSaved = "chain_polish_saved";
        public const string ChainSttResetDone = "chain_stt_reset_done";
        public const string ChainPolishResetDone = "chain_polish_reset_done";
        public const string ChainIdRequired = "chain_id_required";
        public const string ChainBaseRequired = "chain_base_required";
        public const string ChainBaseHttps = "chain_base_https";
        public const string ChainModelRequired = "chain_model_required";
        public const string ChainKeyRequired = "chain_key_required";
        public const string ChainProviderAdded = "chain_provider_added";
        public const string ChainRemoved = "chain_removed";
    ...
    private static readonly Dictionary<string, string> _fa = new()
    {
        ...
        [K.ChainSttTitle] = "زنجیره رونویسی",
        [K.ChainPolishTitle] = "زنجیره پرداخت متن",
        [K.ChainReset] = "بازنشانی",
        [K.ChainResetTip] = "بازگشت به ترتیب پیش‌فرض",
        [K.ChainSttHint] = "ترتیب را با ▲/▼ تغییر دهید؛ تیک را برای فعال/غیرفعال بردارید. حداقل یکی فعال بماند.",
        [K.ChainPolishHint] = "پرداخت با چت: ترتیب تلاش؛ ارائه‌دهنده سفارشی هم اینجاست.",
        [K.ChainCustomTitle] = "ارائه‌دهنده سفارشی (OpenAI-compatible)",
        [K.ChainCustomId] = "شناسه (مثل myprov)",
        [K.ChainCustomName] = "نام نمایشی",
        [K.ChainCustomBase] = "Base URL (باید https)",
        [K.ChainCustomKey] = "کلید API",
        [K.ChainCustomModel] = "مدل",
        [K.ChainCustomAdd] = "افزودن",
        [K.ChainCustomAddTip] = "افزودن ارائه‌دهنده سفارشی به زنجیره پرداخت",
        [K.ChainCustomHint] = "baseURL باید https باشد؛ کلید و مدل الزامی‌اند. حذف از لیست پرداخت هم پاک می‌کند.",
        [K.ChainNoteCustomStt] = "سفارشی — رونویسی",
        [K.ChainNoteUnknown] = "نامشخص",
        [K.ChainPolishDefault] = "پیش‌فرض پرداخت",
        [K.ChainPolishGoogleFallback] = "جایگزین گوگل",
        [K.ChainPolishGroq] = "Groq",
        [K.ChainPolishCustomMissing] = "سفارشی (پاک‌شده؟)",
        [K.ChainSaved] = "ذخیره شد.",
        [K.ChainSttSaved] = "ترتیب رونویسی ذخیره شد.",
        [K.ChainPolishSaved] = "ترتیب پرداخت ذخیره شد.",
        [K.ChainSttResetDone] = "زنجیره رونویسی بازنشانی شد.",
        [K.ChainPolishResetDone] = "زنجیره پرداخت بازنشانی شد.",
        [K.ChainIdRequired] = "شناسه الزامی است.",
        [K.ChainBaseRequired] = "Base URL الزامی است.",
        [K.ChainBaseHttps] = "Base URL باید https باشد.",
        [K.ChainModelRequired] = "مدل الزامی است.",
        [K.ChainKeyRequired] = "کلید الزامی است.",
        [K.ChainProviderAdded] = "ارائه‌دهنده افزوده شد.",
        [K.ChainRemoved] = "حذف شد.",
        [K.Options] = "گزینه‌ها",
        [K.Theme] = "پوسته",
    ...
    private static readonly Dictionary<string, string> _en = new()
    {
        ...
        [K.ChainSttTitle] = "Transcription chain",
        [K.ChainPolishTitle] = "Polish chain",
        [K.ChainReset] = "Reset",
        [K.ChainResetTip] = "Restore default order",
        [K.ChainSttHint] = "Reorder with ▲/▼; toggle to enable/disable. At least one stays active.",
        [K.ChainPolishHint] = "Polish via chat: attempt order; custom providers appear here.",
        [K.ChainCustomTitle] = "Custom provider (OpenAI-compatible)",
        [K.ChainCustomId] = "ID (e.g. myprov)",
        [K.ChainCustomName] = "Display name",
        [K.ChainCustomBase] = "Base URL (must be https)",
        [K.ChainCustomKey] = "API key",
        [K.ChainCustomModel] = "Model",
        [K.ChainCustomAdd] = "Add",
        [K.ChainCustomAddTip] = "Add custom provider to polish chain",
        [K.ChainCustomHint] = "baseURL must be https; key and model required. Removing deletes from polish chain too.",
        [K.ChainNoteCustomStt] = "custom — transcription",
        [K.ChainNoteUnknown] = "unknown",
        [K.ChainPolishDefault] = "default polish",
        [K.ChainPolishGoogleFallback] = "Google fallback",
        [K.ChainPolishGroq] = "Groq",
        [K.ChainPolishCustomMissing] = "custom (missing?)",
        [K.ChainSaved] = "Saved.",
        [K.ChainSttSaved] = "STT order saved.",
        [K.ChainPolishSaved] = "Polish order saved.",
        [K.ChainSttResetDone] = "STT chain reset.",
        [K.ChainPolishResetDone] = "Polish chain reset.",
        [K.ChainIdRequired] = "ID is required.",
        [K.ChainBaseRequired] = "Base URL is required.",
        [K.ChainBaseHttps] = "Base URL must be https.",
        [K.ChainModelRequired] = "Model is required.",
        [K.ChainKeyRequired] = "Key is required.",
        [K.ChainProviderAdded] = "Provider added.",
        [K.ChainRemoved] = "Removed.",
        [K.Options] = "Options",
        [K.Theme] = "Theme",
